...
# Use relative imports for the .exe build
# Skip product router for now since it has SQLAlchemy dependency
# from product.api import router as product_router
# app.include_router(product_router)

# from product.dropdown_api import router as dropdown_router
